...
<head>
    ...
    <title>ALOTSports | Mercurial Collection</title>
...
<body>
        <div class="breadcrumb">
                ...
                <li>MERCURIAL COLLECTION</li>
        </div>
    <div class="grid-container">
        <div class="logo-left">
            <img src="/images/logo_mercurial.png" alt="">
        </div>
        <div class="item">
            <h2>Nike Mercurial Collection</h2>
            <p>Designed for sport, crafted for life. <br> See what's happening with Nike Sportswear. Check out the
                latest
