...
<head>
    ...
    <title>ALOTSports | Encryption Pack</title>
...
<body>
    <div class="breadcrumb">
        ...
        <li>ENCRYPTION PACK</li>
    </div>
    <div class="grid-container">
        <div class="logo-left">
            <img src="/images/adidas-logo.png" alt="" style="height: 10vw; top: 4.2vw;">
        </div>
        <div class="item">
            <h2>adidas Encryption Pack</h2>
            <p>Adidas designs for athletes of all kinds. Creators who love to change the game. <br>
                adidas revealed the Encryption Pack <br> – an understated grey and green colour up for Predator, NEMEZIZ and X boots.
            </p>
        </div>
        <div class="item1">
        ...
        <div class="item2">
            <div class="colour">
                <h5>Colour</h5>
                <button class="filter-button" data-filter="Blue" style="background-color: blue"></button>
                ...
                <button class="filter-button" data-filter="Pink" style="background-color: Pink"></button>
            </div>
            <div class="reset">
        ...
        <div class="item3 dropdown">
            <div id="myDropdown" class="products dropdwon-content">
                ...
                WHERE category='Football Boots' AND brand='adidas'";
