...
<div class="breadcrumb">
    ...
    <div class="grid-container">
        <div class="logo-left">
            <img src="/images/adidas-logo.png" alt="" style="height: 10vw; top: 5vw;">
        </div>
        <div class="item">
            <h2>Explore Adidas Brand</h2>
            <p>Adidas designs for athletes of all kinds. Creators who love to change the game.
                <br> People who challenge conventions,<br>
                break the rules, and define new ones. Then break them all over again. <br> We design sports apparel that
                gets you moving,
                winning, and living life to the fullest.</p>
        </div>
        <div class="item1">
